...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17045__auto__,writer__17046__auto__,opt__17047__auto__){
return cljs.core._write.call(null,writer__17046__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16447__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16447__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16447__auto__)){
return or__16447__auto__;
} else {
...
var G__23676 = o;
(G__23676[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_23680 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23680))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23680)].join(''):class$));
} else {
}
...
var node__$1 = (this$["getDOMNode"])();
var node_value = (node__$1["value"]);
if(cljs.core.not_EQ_.call(null,value,node_value)){
if(cljs.core.not.call(null,(function (){var and__16435__auto__ = (node__$1 === document.activeElement);
if(and__16435__auto__){
var and__16435__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node__$1["type"]));
...
return (node__$1["value"] = value);
} else {
var existing_offset_from_end = (cljs.core.count.call(null,node_value) - (node__$1["selectionStart"]));
var new_cursor_offset = (cljs.core.count.call(null,value) - existing_offset_from_end);
(node__$1["value"] = value);

(node__$1["selectionStart"] = new_cursor_offset);

return (node__$1["selectionEnd"] = new_cursor_offset);
}
} else {
return null;
}
...
if(cljs.core.truth_((function (){var and__16435__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23683 = jsprops;
(G__23683["defaultValue"] = value);

(G__23683["onChange"] = ((function (G__23683,v,value,on_change){
return (function (p1__23681_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23681_SHARP_);
});})(G__23683,v,value,on_change))
);
...
var vec__23685 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23685,(0),null);
var id = cljs.core.nth.call(null,vec__23685,(1),null);
var class$ = cljs.core.nth.call(null,vec__23685,(2),null);
...
var temp__4427__auto__ = (function (){var G__23689 = cljs.core.meta.call(null,v);
var G__23689__$1 = (((G__23689 == null))?null:reagent.impl.template.get_key.call(null,G__23689));
return G__23689__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23691_23692 = v;
var G__23691_23693__$1 = (((G__23691_23692 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23691_23692));
var G__23691_23694__$2 = (((G__23691_23693__$1 == null))?null:(jsprops["key"] = G__23691_23693__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__23697 = cljs.core.meta.call(null,argv);
var G__23697__$1 = (((G__23697 == null))?null:reagent.impl.template.get_key.call(null,G__23697));
return G__23697__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__23698 = (((jsprops == null))?{}:jsprops);
(G__23698["key"] = key);
...
var G__23699 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23699;
continue;
}
} else {
...
var n__17350__auto___23700 = a.length;
var i_23701 = (0);
while(true){
if((i_23701 < n__17350__auto___23700)){
(a[i_23701] = reagent.impl.template.as_element.call(null,(a[i_23701])));
...
var a = cljs.core.into_array.call(null,s);
var n__17350__auto___23703 = a.length;
var i_23704 = (0);
while(true){
if((i_23704 < n__17350__auto___23703)){
var val_23705 = (a[i_23704]);
if((cljs.core.vector_QMARK_.call(null,val_23705)) && ((reagent.impl.template.key_from_vec.call(null,val_23705) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23704] = reagent.impl.template.as_element.call(null,val_23705));
...
if(cljs.core.truth_((function (){var and__16435__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16435__auto__){
return (ctx["no-key"]);
} else {
return and__16435__auto__;
...
var G__23708 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23708) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23708){
